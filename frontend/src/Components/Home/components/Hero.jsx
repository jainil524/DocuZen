...
Hero.defaultProps = {
  ...
  image1Alt: 'Illustration depicting AI-powered documentation tool in action',
  ...
  content1:
    'Effortlessly generate and manage comprehensive API docs with our cutting-edge AI tool.',
