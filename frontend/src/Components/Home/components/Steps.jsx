...
Steps.defaultProps = {
  step1Description:
    'Create an account on DocuZen to access the AI-powered tool for generating and managing API documentation.',
  step3Description:
    'Tailor the documentation to your specific needs and requirements with our user-friendly interface.',
  step2Title: 'Generate API Documentation',
  step2Description:
    'Effortlessly generate comprehensive API documentation using our cutting-edge AI technology.',
  step1Title: 'Sign Up for DocuZen',
  step3Title: 'Customize Your Documentation',
  step4Description:
    'Once satisfied with your documentation, publish it and easily share it with your team or clients.',
  step4Title: 'Publish and Share',
}
